    ...
    render() {
        ...
        return (
            <div className="contentTutor">
                ...
                {this.props.check == "1"?
                <img id="check" alt="Đã xác thực thông tin" title="Đã xác thực bằng cấp" className="check" src="https://www.gnapartners.com/wp-content/uploads/check-icon.png" />:<div></div>}
                </div>
